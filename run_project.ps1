...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'OptiGene FastAPI Server' -ForegroundColor Cyan; conda run -n spark311 uvicorn backend.app:app --host 127.0.0.1 --port 5000 --reload"
